...
reference size.
"""
function refine_fraction(points, simplex_inds, refsize, reflast, k, factor)
    ...
    refine_fraction(allpoints, all_simplex_inds, refsize, reflast, k, factor)
